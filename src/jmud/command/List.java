...
class List extends Command {
    ...
    List(String name, int mRank, int mPos, int opt) {
	super(name, mRank, mPos, opt);
    }

    public void execute(Char aChar, CommandTokenizer toker, String cmd) {

	ShopCreature keeper = aChar.getPlace().findShopKeeper();
	...
	aChar.send("NÚMERO QUANTIDADE ITEM                                                   PREÇO" + Separators.NL + "------ ---------- ------------------------------------------------------ -----" + keeper.getShopList(aChar));
    }
}
