...
class Create extends Command {
    ...
    static final String SYNTAX = "Sintaxe: crie item|criatura <número>";
	...
	try {
	    ...
	    aChar.send("Você deve especificar um número.");
	    return;
	}
	...
	if (item.startsWith(opt)) {
	    ...
	    if (itPro == null)
		aChar.send("Item não encontrado.");
	    else {
	    ...
	    if (crPro == null)
		aChar.send("Criatura não encontrada.");
	    else {
