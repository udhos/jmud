...
class Donate extends Command {
    ...
    Donate(String name, int mRank, int mPos, int opt) {
	super(name, mRank, mPos, opt);
    }

    public void execute(Char aChar, CommandTokenizer toker, String cmd) {
	if (!toker.hasMoreTokens()) {
	    aChar.send("O que você quer doar?");
	    return;
	}
	...
	if (it != null) {
	    ...
	    aChar.getPlace().action("$p doou $i: um relâmpago desintegrou a oferenda!", true, aChar, it);
	}
	else
